    ...
    <div class="container mx-auto px-4 py-8 max-w-2xl">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <form action="{{ route('admin.harvests.update', $harvest) }}" method="POST">
                <h1 class="text-3xl font-bold mb-6 text-center p-6">Edit Data Panen</h1>
                @csrf
                 @method('PUT')
                 <div class="mt-18">
                     <div class="mb-4">
                         <label class="block text-gray-700 font-semibold mb-2">Nama Kelompok Tani</label>
                         <input type="text" name="nama_kelompok_tani" value="{{ old('nama_kelompok_tani', $harvest->nama_kelompok_tani) }}"
                     ...
                     <div class="mb-4">
                         ...
                         <input type="text" name="hasil_pertanian" value="{{ old('hasil_pertanian', $harvest->hasil_pertanian) }}"
                     ...
                     <div class="mb-4">
                         ...
                         <input type="text" name="varian" value="{{ old('varian', $harvest->varian) }}"
                      ...
                      <div class="mb-4">
                         ...
                         <input type="text" name="Total_panen" value="{{ old('Total_panen', $harvest->Total_panen) }}"
                     ...
                     <div class="mb-4">
                         ...
                         <input type="text" name="Stok_tersedia" value="{{ old('Stok_tersedia', $harvest->Stok_tersedia) }}"
                     ...
                     <div class="mb-4">
                         ...
                         <input type="text" name="nomor_hp" value="{{ old('nomor_hp', $harvest->nomor_hp) }}"
                     ...
                     <div class="mb-4">
                         ...
                         <input type="date" name="tanggal_panen" value="{{ old('tanggal_panen',  $harvest->tanggal_panen->format('Y-m-d')) }}"
                     ...
                     <div class="mb-6">
                         ...
                         <input type="text" name="lokasi" value="{{ old('lokasi', $harvest->lokasi) }}"
